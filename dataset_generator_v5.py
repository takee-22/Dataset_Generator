# v5: Each video now saves frames into its own subfolder inside SAVE_DIR.
# Subfolder is named after the video file for easy organization.
# Helps avoid clutter when processing large batches of footage.
