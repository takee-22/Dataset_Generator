# v7: Integrated YOLO inference for auto-labeling.
# Each saved frame now generates a YOLO format .txt label and a visualized output.
# Frames with no detections are skipped. Output split into images/, labels/, viz/.
...
for video_name in videos:
    ...
    while True:
        ...
        if frame_id % stride == 0:
            ...
            base = time.strftime("frame_%Y%m%d_%H%M%S")
